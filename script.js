...
// To change the colours of the segments according to time
// I have given each of the segments an ID that related to their hour
// Put those IDs into a variable, and then looped through the array

var elements = document.querySelectorAll("a");
for (var i= 0; i < elements.length; i++) {
  if (elements[i].id == currenthour) {
  ...
  if (elements[i].id > currenthour) {
    $(elements[i]).css("background-color", "darkgreen");
  }  
